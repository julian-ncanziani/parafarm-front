    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        <button
          ...
          className={`mt-4 w-full ${isAdded ? 'bg-green-500' : 'bg-blue-500'} text-white py-2 px-4 rounded-md hover:${isAdded ? '' : 'bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
          disabled={isAdded}
        >
