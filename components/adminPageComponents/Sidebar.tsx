                    ...
                    <ul className="space-y-2">
                        <li>
                            ...
                            >
                                ...
                                {isSidebarOpen && <Link href='/admin' className="ml-4 hover:underline">Home</Link>}
                            </button>
                        </li>
                        <li>
                            <button
                            ...
                            >
                                ...
                                {isSidebarOpen && <Link href="/admin" className="ml-4 hover:underline">Productos</Link>}
                            </button>
                        </li>
                        <li>
                            <button
                            ...
                            >
                                ...
                                {isSidebarOpen && <Link href="/admin" className="ml-4 hover:underline">Ordenes</Link>}
                            </button>
                        </li>
                        <li>
                            <button
                            ...
                            >
                                ...
                                {isSidebarOpen && <Link href="/admin" className="ml-4 hover:underline">Usuarios</Link>}
                            </button>
                        </li>
                        <li>
                            <button
                            ...
                            >
                                ...
                                {isSidebarOpen && <Link href="/admin" className="ml-4 hover:underline">Settings</Link>}
                            </button>
                        </li>
                        <li>
                            <a 
